...
begin
  ...
  p := Pointer(Integer(p) + SizeOf(TColor));
  ...
  begin
    ...
    p := Pointer(Integer(p) + SizeOf(Real));
...
begin
  ...
  color := col;
  buff := Pointer(Integer(buff) + SizeOf(TColor));
  System.Move(buff^, int, SizeOf(Integer));
  width := int;
  buff := Pointer(Integer(buff) + SizeOf(Integer));
  ...
  begin
    ...
    _points[i].x := float;
    buff := Pointer(Integer(buff) + SizeOf(Real));
    System.Move(buff^, float, SizeOf(Real));
    _points[i].y := float;
    buff := Pointer(Integer(buff) + SizeOf(Real));
  end;
...
begin
  ...
  bgColorMode := bool;
  buff := Pointer(Integer(buff) + SizeOf(Boolean));
  System.Move(buff^, int, SizeOf(Integer));
  width := int;
  buff := Pointer(Integer(buff) + SizeOf(Integer));
  System.Move(buff^, float, SizeOf(Real));
